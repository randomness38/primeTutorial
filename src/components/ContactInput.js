...
const DumbContactForm = (props) => {
    ...
    return (
        <View>
            ...
            <Field  name='username' keyboardType='default' label='user name : ' component={ContactForm}/>
            <Field  name='email' keyboardType='email-address' label='Email: ' component={ContactForm}/>
            <Field  name='age' keyboardType='numeric' label='Age: ' component={ContactForm}/>
